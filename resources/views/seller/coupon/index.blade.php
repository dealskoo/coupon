        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="row mb-2">
                        <div class="col-12">
                            <a href="{{ route('seller.coupons.create') }}" class="btn btn-danger mb-2"><i
                                    class="mdi mdi-plus-circle me-2"></i> {{ __('coupon::coupon.add_coupon') }}
                            </a>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        $(function () {
            let table = $('#coupons_table').dataTable({
                "processing": true,
                "serverSide": true,
                "ajax": "{{ route('seller.coupons.index') }}",
                "language": language,
                ...
                "drawCallback": function () {
                    ...
                    $('#coupons_table tr td:nth-child(16)').addClass('table-action');
                    delete_listener();
                }
            });
