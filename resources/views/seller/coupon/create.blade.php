...
@section('title',__('coupon::coupon.add_coupon'))
@section('body')
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">{{ __('coupon::coupon.add_coupon') }}</li>
                    </ol>
                </div>
                <h4 class="page-title">{{ __('coupon::coupon.add_coupon') }}</h4>
            </div>
        </div>
    </div>
    <div class="row">
